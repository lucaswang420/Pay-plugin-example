# Final Performance Test - Working Endpoints Only
$BaseUrl = "http://localhost:5566"
$ApiKey = "performance-test-key"

Write-Host "========================================"
Write-Host "Pay Plugin Performance Test (Final)"
Write-Host "========================================"
Write-Host ""
...
Write-Host "  /metrics: $($metrics_p50 -lt 50 ? 'PASS' : 'FAIL')" -ForegroundColor ($metrics_p50 -lt 50 ? "Green" : "Red")
Write-Host "  /pay/query: $($query_p50 -lt 50 ? 'PASS' : 'FAIL')" -ForegroundColor ($query_p50 -lt 50 ? "Green" : "Red")
Write-Host "  /pay/metrics/auth: $($auth_p50 -lt 50 ? 'PASS' : 'FAIL')" -ForegroundColor ($auth_p50 -lt 50 ? "Green" : "Red")
Write-Host ""
Write-Host "  Target: P95 < 200ms"
Write-Host "  /metrics: $($metrics_p95 -lt 200 ? 'PASS' : 'FAIL')" -ForegroundColor ($metrics_p95 -lt 200 ? "Green" : "Red")
Write-Host "  /pay/query: $($query_p95 -lt 200 ? 'PASS' : 'FAIL')" -ForegroundColor ($query_p95 -lt 200 ? "Green" : "Red")
Write-Host "  /pay/metrics/auth: $($auth_p95 -lt 200 ? 'PASS' : 'FAIL')" -ForegroundColor ($auth_p95 -lt 200 ? "Green" : "Red")
Write-Host ""
Write-Host "  Target: Throughput >= 100 RPS"
Write-Host "  /metrics: $($metrics_rps -ge 100 ? 'PASS' : 'FAIL')" -ForegroundColor ($metrics_rps -ge 100 ? "Green" : "Red")
Write-Host "  /pay/query: $($query_rps -ge 100 ? 'PASS' : 'FAIL')" -ForegroundColor ($query_rps -ge 100 ? "Green" : "Red")
Write-Host "  /pay/metrics/auth: $($auth_rps -ge 100 ? 'PASS' : 'FAIL')" -ForegroundColor ($auth_rps -ge 100 ? "Green" : "Red")
