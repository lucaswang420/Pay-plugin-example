...
const std::string PayRefund::Cols::_id = "\"id\"";
...
const bool PayRefund::hasPrimaryKey = true;
const std::string PayRefund::tableName = "\"pay_refund\"";

const std::vector<typename PayRefund::MetaData> PayRefund::metaData_={
...
const std::string &PayRefund::getColumnName(size_t index) noexcept(false)
{
    assert(index < metaData_.size());
    return metaData_[index].colName_;
}
PayRefund::PayRefund(const Row &r, const ssize_t indexOffset) noexcept
{
    if(indexOffset < 0)
    {
        if(!r["id"].isNull())
        ...
        if(!r["refund_no"].isNull())
        {
            refundNo_=std::make_shared<std::string>(r["refund_no"].as<std::string>());
        }
    ...
    else
    {
        ...
        if(!r[index].isNull())
        {
            refundNo_=std::make_shared<std::string>(r[index].as<std::string>());
        }
        index = offset + 2;
        if(!r[index].isNull())
        {
...
PayRefund::PayRefund(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false)
{
    ...
    if(!pMasqueradingVector[1].empty() && pJson.isMember(pMasqueradingVector[1]))
    {
        ...
        {
            refundNo_=std::make_shared<std::string>(pJson[pMasqueradingVector[1]].asString());
        }
    }
...
PayRefund::PayRefund(const Json::Value &pJson) noexcept(false)
{
    ...
    if(pJson.isMember("refund_no"))
    {
        dirtyFlag_[1]=true;
        if(!pJson["refund_no"].isNull())
        {
            refundNo_=std::make_shared<std::string>(pJson["refund_no"].asString());
        }
    }
...
void PayRefund::updateByJson(const Json::Value &pJson) noexcept(false)
{
    if(pJson.isMember("id"))
    {
        if(!pJson["id"].isNull())
...
const int64_t &PayRefund::getValueOfId() const noexcept
{
...
const std::shared_ptr<int64_t> &PayRefund::getId() const noexcept
{
    return id_;
}
void PayRefund::setId(const int64_t &pId) noexcept
{
    id_ = std::make_shared<int64_t>(pId);
    dirtyFlag_[0] = true;
}
const typename PayRefund::PrimaryKeyType & PayRefund::getPrimaryKey() const
{
    assert(id_);
    return *id_;
}

const std::string &PayRefund::getValueOfRefundNo() const noexcept
{
...
const std::shared_ptr<std::string> &PayRefund::getRefundNo() const noexcept
{
    return refundNo_;
}
void PayRefund::setRefundNo(const std::string &pRefundNo) noexcept
{
    refundNo_ = std::make_shared<std::string>(pRefundNo);
    dirtyFlag_[1] = true;
}
void PayRefund::setRefundNo(std::string &&pRefundNo) noexcept
{
    refundNo_ = std::make_shared<std::string>(std::move(pRefundNo));
    dirtyFlag_[1] = true;
}

const std::string &PayRefund::getValueOfOrderNo() const noexcept
{
    static const std::string defaultValue = std::string();
    if(orderNo_)
        return *orderNo_;
...
const std::shared_ptr<std::string> &PayRefund::getOrderNo() const noexcept
{
    return orderNo_;
}
void PayRefund::setOrderNo(const std::string &pOrderNo) noexcept
{
    orderNo_ = std::make_shared<std::string>(pOrderNo);
    dirtyFlag_[2] = true;
}
void PayRefund::setOrderNo(std::string &&pOrderNo) noexcept
{
    orderNo_ = std::make_shared<std::string>(std::move(pOrderNo));
    dirtyFlag_[2] = true;
}

const std::string &PayRefund::getValueOfPaymentNo() const noexcept
{
    static const std::string defaultValue = std::string();
    if(paymentNo_)
        return *paymentNo_;
...
const std::shared_ptr<std::string> &PayRefund::getPaymentNo() const noexcept
{
    return paymentNo_;
}
void PayRefund::setPaymentNo(const std::string &pPaymentNo) noexcept
{
    paymentNo_ = std::make_shared<std::string>(pPaymentNo);
    dirtyFlag_[3] = true;
}
void PayRefund::setPaymentNo(std::string &&pPaymentNo) noexcept
{
...
const std::shared_ptr<std::string> &PayRefund::getStatus() const noexcept
{
    return status_;
}
...
const std::shared_ptr<std::string> &PayRefund::getAmount() const noexcept
{
    return amount_;
}
...
const std::shared_ptr<::trantor::Date> &PayRefund::getCreatedAt() const noexcept
{
    return createdAt_;
}
...
const std::shared_ptr<::trantor::Date> &PayRefund::getUpdatedAt() const noexcept
{
    return updatedAt_;
}
...
const std::vector<std::string> &PayRefund::insertColumns() noexcept
{
...
void PayRefund::outputArgs(drogon::orm::internal::SqlBinder &binder) const
{
    if(dirtyFlag_[1])
    {
        if(getRefundNo())
        {
            binder << getValueOfRefundNo();
        }
        else
        {
            binder << nullptr;
...
const std::vector<std::string> PayRefund::updateColumns() const
{
...
void PayRefund::updateArgs(drogon::orm::internal::SqlBinder &binder) const
{
    if(dirtyFlag_[1])
    {
        if(getRefundNo())
...
Json::Value PayRefund::toJson() const
{
    Json::Value ret;
    if(getId())
    {
    ...
    if(getRefundNo())
    {
        ret["refund_no"]=getValueOfRefundNo();
    }
    else
    {
        ret["refund_no"]=Json::Value();
    }
    if(getOrderNo())
    {
...
std::string PayRefund::toString() const
{
    return toJson().toStyledString();
}

Json::Value PayRefund::toMasqueradedJson(
    const std::vector<std::string> &pMasqueradingVector) const
{
    ...
    if(pMasqueradingVector.size() == 9)
    {
        ...
        if(!pMasqueradingVector[1].empty())
        {
            if(getRefundNo())
            {
                ret[pMasqueradingVector[1]]=getValueOfRefundNo();
            }
            else
            {
...
bool PayRefund::validateJsonForCreation(const Json::Value &pJson, std::string &err)
{
    if(pJson.isMember("id"))
    {
    ...
    if(pJson.isMember("refund_no"))
    {
        if(!validJsonOfField(1, "refund_no", pJson["refund_no"], err, true))
            return false;
    }
    else
    {
        err="The refund_no column cannot be null";
        return false;
    }
    if(pJson.isMember("order_no"))
    {
...
bool PayRefund::validateMasqueradedJsonForCreation(const Json::Value &pJson,
...
bool PayRefund::validateJsonForUpdate(const Json::Value &pJson, std::string &err)
{
    if(pJson.isMember("id"))
    {
    ...
    if(pJson.isMember("refund_no"))
    {
        if(!validJsonOfField(1, "refund_no", pJson["refund_no"], err, false))
            return false;
    }
    if(pJson.isMember("order_no"))
    {
...
bool PayRefund::validateMasqueradedJsonForUpdate(const Json::Value &pJson,
                                                 const std::vector<std::string> &pMasqueradingVector,
                                                 std::string &err)
{
    if(pMasqueradingVector.size() != 9)
...
bool PayRefund::validJsonOfField(size_t index,
