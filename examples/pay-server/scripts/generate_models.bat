...
REM Models live in the drogon-pay library, not the example host.
REM drogon_ctl reads models/model.json from the target directory.
cd /d "%~dp0..\..\..\libs\drogon-pay\src"
...
echo ========================================
echo.
echo Generated models: libs/drogon-pay/src/models/
echo Backup saved to: libs/drogon-pay/src/models_backup/
echo.
echo NOTE: If model interfaces changed, you may need to update:
echo   - libs/drogon-pay/src/services/*Service.cc
echo   - libs/drogon-pay/src/handlers/*.cc
echo   - libs/drogon-pay/src/PayPlugin.cc
echo.
